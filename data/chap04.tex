...
\begin{figure}[htbp]
	\centering
	\subfloat[$ p_2 $处理结果]{\includegraphics[width=0.3\textwidth]{img/db3.png}}
	\subfloat[$ p_3 $处理结果]{\includegraphics[width=0.3\textwidth]{img/db4.png}}
	\subfloat[$ p_8 $处理结果]{\includegraphics[width=0.3\textwidth]{img/db5.png}}
	\caption{聚类处理过程}
	\label{db_process}
\end{figure}
...
经过合并后，得到最终聚类结果，如图\ref{dbres}所示，可以看到数据集包含两个簇，其中黄色为簇1，紫色为簇2。
\begin{figure}[htbp]
	\centering
