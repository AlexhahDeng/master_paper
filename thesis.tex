...
%
%7. 如果是专硕，则使用prof选项
\documentclass[master,biber,resumebib,ttf,anon,prof]{nudtpaper}
...
\ensupervisor{Prof. Shaojing Fu}%{Prof. Fu ShaoJing}
\encosupervisor{Associate Prof. Lin Liu}%{Lecture. Liu Lin} 
\papertype{工学}
