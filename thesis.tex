...
%
%7. 如果是专硕，则使用prof选项
\documentclass[master,biber,resumebib,ttf,prof]{nudtpaper}
%
...
\enauthor{Deng Yanxiang}
\endate{\entoday}
\subject{工程硕士}
\ensubject{Computer Technology}
\researchfield{计算机技术}
\supervisor{付绍静\quad{}教授}
\cosupervisor{柳林\quad{}副教授} % 没有就空着
\ensupervisor{Prof. Fu ShaoJing}%{Prof. Fu ShaoJing}
\encosupervisor{Associate Prof. Liu Lin}%{Lecture. Liu Lin} % 没有就空着
\papertype{工学}
